...
Exploration Agent    green
Web Search           green
Web Fetch            green
Feedback Memory      green
Morning Signal       green
...
5. Telegram으로 보내기
6. SQLite에 실행 기록 저장하기
7. Paperclip UI에서 실행 결과 보기
8. Paperclip UI에서 피드백 저장하기
9. 피드백을 다음 exploration prompt에 반영하기
10. GitHub/HN/RSS는 필요할 때 보조 소스로 안정화하기
11. YouTube/Instagram/Fiction 탐색 능력 확장하기
12. Re-rank 버튼으로 실시간 재추천하기
